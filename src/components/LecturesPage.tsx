  ...
  return (
    <div className="own_edge min-h-screen relative overflow-hidden">
      <Helmet>
        ...
        <meta name="description" content="Praktické vzdelávanie záhradkárov." />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Praktické vzdelávanie záhradkárov."
        />
        <meta
          property="og:url"
          content="https://www.zvazzahradkarov.sk/prednasky"
        />
