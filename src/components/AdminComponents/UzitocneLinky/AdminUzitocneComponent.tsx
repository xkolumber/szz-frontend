...
const AdminUzitocneComponent = ({ data, refetch }: Props) => {
  ...
  const handleSaveData = async (event: any) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/admin/uzitocnepage/updateuzitocnepage`,
        {
          method: "PUT",
          headers: {
...
export default AdminUzitocneComponent;
